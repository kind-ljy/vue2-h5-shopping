    ...
    <div class="cart-box"
      ...
      <div class="cart-list">
        <div class="cart-item"
          ...
          <van-checkbox icon-size="18"
                        ...
                        @click="toggleCheck(item.goods_id)"></van-checkbox>
          <div class="show"
          ...
          <div class="info">
            ...
            <span class="bottom">
              ...
              <!-- 既希望保留原本形参，又需要通过调用函数传参=> 箭头函数包装一层 -->
              <CountBox :value="item.goods_num"
                        @input="(num)=>changeCount(num,item.goods_id,item.goods_sku_id)"></CountBox>
            </span>
          </div>
        </div>
      </div>
      ...
      <div class="footer-fixed">
        <div class="all-check"
          ...
          <van-checkbox icon-size="18"
                        :value="isAllChecked"></van-checkbox>
          全选
        </div>
        ...
        <div class="all-total">
          ...
          <div v-else
               class="delete"
               :class="{disabled: selCount===0}"
               @click="handleDel">删除({{ selCount }})</div>
        </div>
      </div>
    </div>
